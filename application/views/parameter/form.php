...
<div style="margin-bottom:10px">
    <input name="parametergrpid" class="easyui-textbox" required="true" labelPosition="left"  value="<?= @$data->parametergrpid ?>"  label="parametergrpid:" style="width:100%">
</div>
<div style="margin-bottom:10px">
    <input name="parameterid" class="easyui-textbox" required="true" labelPosition="left"  value="<?= @$data->parameterid ?>"  label="parameterid:" style="width:100%">
</div>
<div style="margin-bottom:10px">
